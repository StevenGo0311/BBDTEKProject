...
public class SearchResultActivity extends BaseActivity implements
     ...
     * 索搜空界面
     */
    @BindView(R.id.search_no_result_textView)
    TextView mTextViewSearchNoresult;
    /**
     * 搜索结果列表
     */
    @BindView(R.id.search_listview_result)
    SearchResultListView mListView;

    @BindView(R.id.id_imageview_back_search_result)
    ImageView mIMageviewSearchResult;
